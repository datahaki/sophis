...
import ch.alpine.sophis.itp.BiinvariantMeanInterpolation;
...
class BiinvariantMeanInterpolationTest {
  ...
  void testSimple() throws ClassNotFoundException, IOException {
    ...
    Interpolation bi = Serialization.copy(BiinvariantMeanInterpolation.of(LinearBiinvariantMean.INSTANCE, vector));
  ...
  void testMultiRn() {
    ...
    Interpolation interp1 = BiinvariantMeanInterpolation.of(LinearBiinvariantMean.INSTANCE, tensor);
  ...
  void testMultiSe2() {
    ...
    Interpolation interp1 = BiinvariantMeanInterpolation.of(Se2CoveringGroup.INSTANCE.biinvariantMean(), tensor);
