...
class ArcLengthParameterizationTest {
  ...
  @Test
  void testFailLength() {
    assertThrows(Exception.class, () -> ArcLengthParameterization.of(Tensors.vector(1, 2, 3), RGroup.INSTANCE, Tensors.vector(1, 2, 3)));
  }

  @Test
  void testFailNonVector() {
    assertThrows(Exception.class, () -> ArcLengthParameterization.of(HilbertMatrix.of(3), RGroup.INSTANCE, Tensors.vector(1, 2, 3, 4)));
  }
