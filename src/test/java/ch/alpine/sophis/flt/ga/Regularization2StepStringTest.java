...
class Regularization2StepStringTest {
  private static final TensorUnaryOperator STRING = //
      Regularization2Step.string(RGroup.INSTANCE, RationalScalar.of(1, 4));
  ...
  void testLo() throws ClassNotFoundException, IOException {
    ...
    TensorUnaryOperator tensorUnaryOperator = Regularization2Step.string(RGroup.INSTANCE, RealScalar.of(0.25));
  ...
  void testSimple() {
    TensorUnaryOperator STRING = //
        Regularization2Step.string(RGroup.INSTANCE, RationalScalar.of(1, 2));
  ...
  void testZero() {
    ...
    Tensor tensor = Regularization2Step.string(RGroup.INSTANCE, RealScalar.ZERO).apply(signal);
    ExactTensorQ.require(tensor);
  ...
  @Test
  void testScalarFail() {
    TensorUnaryOperator tensorUnaryOperator = Regularization2Step.string(RGroup.INSTANCE, RationalScalar.HALF);
