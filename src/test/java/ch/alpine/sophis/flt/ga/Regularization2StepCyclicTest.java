...
class Regularization2StepCyclicTest {
  private static final TensorUnaryOperator CYCLIC = //
      Regularization2Step.cyclic(RGroup.INSTANCE, RationalScalar.of(1, 4));
  ...
  void testLo() {
    ...
    TensorUnaryOperator regularization2StepCyclic = Regularization2Step.cyclic(RGroup.INSTANCE, RealScalar.of(0.25));
  ...
  void testHi() {
    ...
    TensorUnaryOperator tensorUnaryOperator = Regularization2Step.cyclic(RGroup.INSTANCE, RealScalar.of(0.25));
  ...
  void testZero() {
    ...
    Tensor tensor = Regularization2Step.cyclic(RGroup.INSTANCE, RealScalar.ZERO).apply(signal);
    ExactTensorQ.require(tensor);
  ...
  @Test
  void testScalarFail() {
    TensorUnaryOperator tensorUnaryOperator = Regularization2Step.cyclic(RGroup.INSTANCE, RationalScalar.HALF);
