...
class GeodesicIIR1Test {
  ...
  void testSimple() throws ClassNotFoundException, IOException {
    GeodesicIIR1 geodesicIIR1 = //
        Serialization.copy(new GeodesicIIR1(RGroup.INSTANCE, RealScalar.of(0.5)));
    // irc=0.0[s^-2]
  ...
  void testInitialized() {
    GeodesicIIR1 geodesicIIR1 = new GeodesicIIR1(RGroup.INSTANCE, RealScalar.of(0.5));
  ...
  @Test
  void testNullFail() {
    GeodesicIIR1 geodesicIIR1 = new GeodesicIIR1(RGroup.INSTANCE, RealScalar.of(0.2));
    assertThrows(Exception.class, () -> geodesicIIR1.apply(null));
  }

  @Test
  void testZeroFail() {
    assertThrows(Exception.class, () -> new GeodesicIIR1(RGroup.INSTANCE, RealScalar.of(0)));
  }

  @Test
  void testLargeFail() {
    assertThrows(Exception.class, () -> new GeodesicIIR1(RGroup.INSTANCE, RealScalar.of(1.01)));
  }
}
