...
class GeodesicFIRnTest {
  ...
  void testSimple() {
    ...
    TensorUnaryOperator tensorUnaryOperator = GeodesicFIRn.of(Mean::of, RGroup.INSTANCE, 2, RationalScalar.of(1, 2));
    ...
    Tensor q = s3;
    assertEquals(tensor, RGroup.INSTANCE.split(p, q, RationalScalar.HALF));
