...
import ch.alpine.sophis.ref.d1.Split3Dual3PointCurveSubdivision;
...
class Split3Dual3PointCurveSubdivisionTest {
  private static final CurveSubdivision CURVE_SUBDIVISION = //
      Split3Dual3PointCurveSubdivision.of(RGroup.INSTANCE, RationalScalar.of(1, 3), RationalScalar.of(1, 5), RationalScalar.of(1, 4));
