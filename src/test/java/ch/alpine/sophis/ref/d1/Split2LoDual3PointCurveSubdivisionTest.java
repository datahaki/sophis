...
import ch.alpine.sophis.ref.d1.Split2LoDual3PointCurveSubdivision;
...
class Split2LoDual3PointCurveSubdivisionTest {
  private static final CurveSubdivision CURVE_SUBDIVISION = //
      Split2LoDual3PointCurveSubdivision.of(RGroup.INSTANCE, RationalScalar.of(1, 3), RationalScalar.of(1, 4));
