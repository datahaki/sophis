...
class BSpline4CurveSubdivisionTest {
  @Test
  void testSplit2Lo() {
    CurveOperator curveSubdivision = BSpline4CurveSubdivision.split2lo(RGroup.INSTANCE);
  ...
  @Test
  void test2Lo() {
    CurveOperator curveSubdivision = BSpline4CurveSubdivision.split3(RGroup.INSTANCE, Rational.of(1, 6));
  ...
  @Test
  void testSplit3() {
    CurveOperator curveSubdivision = BSpline4CurveSubdivision.split3(RGroup.INSTANCE);
    Tensor tensor = curveSubdivision.string(UnitVector.of(5, 2));
    assertEquals(tensor, Tensors.fromString("{0, 1/16, 5/16, 5/8, 5/8, 5/16, 1/16, 0}"));
  }
  ...
  @Test
  void test2Hi() {
    CurveOperator curveSubdivision = BSpline4CurveSubdivision.split2hi(RGroup.INSTANCE);
    Tensor tensor = curveSubdivision.string(UnitVector.of(5, 2));
    assertEquals(tensor, Tensors.fromString("{0, 1/16, 5/16, 5/8, 5/8, 5/16, 1/16, 0}"));
  }
  ...
  void testSingleton() {
    ...
    CurveOperator curveSubdivision = BSpline4CurveSubdivision.split2lo(ClothoidBuilders.SE2_ANALYTIC.clothoidBuilder());
  ...
  void testSerializable() throws ClassNotFoundException, IOException {
    TensorUnaryOperator fps = BSpline4CurveSubdivision.split2lo(RGroup.INSTANCE)::cyclic;
