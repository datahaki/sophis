...
class BSpline4CurveSubdivisionTest {
  ...
  @Test
  void testSplit3() {
    CurveSubdivision curveSubdivision = BSpline4CurveSubdivision.split3(RGroup.INSTANCE);
    Tensor tensor = curveSubdivision.string(UnitVector.of(5, 2));
    assertEquals(tensor, Tensors.fromString("{0, 1/16, 5/16, 5/8, 5/8, 5/16, 1/16, 0}"));
  }
  ...
  @Test
  void test2Hi() {
    CurveSubdivision curveSubdivision = BSpline4CurveSubdivision.split2hi(RGroup.INSTANCE);
    Tensor tensor = curveSubdivision.string(UnitVector.of(5, 2));
    assertEquals(tensor, Tensors.fromString("{0, 1/16, 5/16, 5/8, 5/8, 5/16, 1/16, 0}"));
  }
