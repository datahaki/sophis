...
class MetricBiinvariantTest {
  ...
  @Test
  void testFail() {
    assertThrows(Exception.class, () -> new MetricBiinvariant(RGroup.INSTANCE).weighting(null));
    assertThrows(Exception.class, () -> new MetricBiinvariant(RGroup.INSTANCE).coordinate(null));
  }
}
