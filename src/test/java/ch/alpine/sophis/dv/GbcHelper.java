...
public enum GbcHelper {
  ...
  public static BarycentricCoordinate[] barycentrics(Manifold manifold) { //
    return new BarycentricCoordinate[] { //
        ...
        new HsCoordinates(new HsDesign(manifold), new MetricBiinvariant(RGroup.INSTANCE).coordinate(InversePowerVariogram.of(1))), //
        new HsCoordinates(new HsDesign(manifold), new MetricBiinvariant(RGroup.INSTANCE).coordinate(InversePowerVariogram.of(2))), //
