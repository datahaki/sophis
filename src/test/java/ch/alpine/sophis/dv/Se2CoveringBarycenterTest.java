...
class Se2CoveringBarycenterTest {
  ...
  void testZeros() {
    ...
    Tensor result = Se2CoveringGroup.INSTANCE.biinvariantMean().mean(sequence, weights);
  ...
  void testRank() {
    ...
    Se2CoveringGroup.INSTANCE.biinvariantMean().mean(sequence.extract(0, 2), Tensors.of(RealScalar.ONE.subtract(w), w));
  }
