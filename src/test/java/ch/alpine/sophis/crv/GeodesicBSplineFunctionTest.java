  ...
  void testLetsSee() {
    ...
    for (int n = 1; n < 10; ++n)
      for (int degree = 0; degree < 6; ++degree) {
        ...
        ScalarTensorFunction stf2 = GeodesicBSplineFunction.of(RGroup.INSTANCE, degree, control);
  ...
  void testSasdlkjh() {
    {
      ...
      GeodesicBSplineFunction.of(RGroup.INSTANCE, 1, knots, knots);
    }
    Tensor knots = Tensors.vector(1, 2, 3, 2, 5);
    assertThrows(Exception.class, () -> GeodesicBSplineFunction.of(RGroup.INSTANCE, 1, knots, knots));
  }

  @Test
  void testDegreeFail() {
    assertThrows(Exception.class, () -> GeodesicBSplineFunction.of(RGroup.INSTANCE, -1, UnitVector.of(7, 3)));
  }

  @Test
  void testKnotsFail() {
    assertThrows(Exception.class, () -> GeodesicBSplineFunction.of(RGroup.INSTANCE, 3, Range.of(0, 10), Range.of(0, 11)));
  }

  @Test
  void testKnotsUnsortedFail() {
    assertThrows(Exception.class, () -> GeodesicBSplineFunction.of(RGroup.INSTANCE, 3, Tensors.vector(3, 2, 1), Tensors.vector(1, 2, 3)));
  }
}
