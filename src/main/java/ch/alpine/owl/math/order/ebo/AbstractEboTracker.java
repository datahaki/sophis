// code by astoll
package ch.alpine.owl.math.order.ebo;
...
import ch.alpine.owl.math.order.ScalarSlackSemiorder;
...
/** immutable */
/* package */ record Pair<K>(K key, Tensor value) implements Serializable {
  // ---
}
